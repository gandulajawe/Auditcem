...
// Validate ../../src/app/api/weekly/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/weekly">> = Specific
  const handler = {} as typeof import("../../src/app/api/weekly/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
